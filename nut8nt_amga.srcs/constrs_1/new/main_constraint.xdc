...
set_property PACKAGE_PIN AG3 [get_ports {da_p[1]}]
set_property PACKAGE_PIN AH3 [get_ports {da_n[1]}]
set_property PACKAGE_PIN AE3 [get_ports {da_p[0]}]
set_property PACKAGE_PIN AF3 [get_ports {da_n[0]}]
...
#set_clock_groups -asynchronous -group clk_pl_0  ###S
...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks lclk_p]
set_clock_groups -asynchronous -group {clk_pl_0}
...
set_property PACKAGE_PIN AG14 [get_ports LED1]
set_property PACKAGE_PIN AH14 [get_ports LED2]
set_property PACKAGE_PIN AG13 [get_ports LED3]
set_property PACKAGE_PIN AH13 [get_ports LED4]
...
set_property PACKAGE_PIN AE8 [get_ports spi_scz]
set_property PACKAGE_PIN AH8 [get_ports spi_sclk]
set_property PACKAGE_PIN AB7 [get_ports spi_sdata]

set_property IOSTANDARD LVCMOS18 [get_ports spi_scz_t]
set_property IOSTANDARD LVCMOS18 [get_ports spi_sclk_t]
set_property IOSTANDARD LVCMOS18 [get_ports spi_sdata_t]

set_property PACKAGE_PIN AG10 [get_ports spi_scz_t]
set_property PACKAGE_PIN AF11 [get_ports spi_sclk_t]
set_property PACKAGE_PIN AH10 [get_ports spi_sdata_t]

set_property PULLDOWN true [get_ports spi_sclk]
set_property PULLDOWN true [get_ports spi_sdata]
set_property SLEW SLOW [get_ports spi_scz]
set_property PULLDOWN true [get_ports spi_scz]

set_property PACKAGE_PIN A12 [get_ports nt1spi_csn]
set_property PACKAGE_PIN A11 [get_ports nt1spi_mosi]
set_property PACKAGE_PIN J10 [get_ports nt1spi_sclk]
set_property PACKAGE_PIN J11 [get_ports nt1spi_miso]
...
set_property PACKAGE_PIN K4 [get_ports m5717_CSn]
set_property PACKAGE_PIN L3 [get_ports m5717_din]
set_property PACKAGE_PIN L2 [get_ports m5717_sclk]
set_property PACKAGE_PIN L1 [get_ports tx_frame_p]
set_property PACKAGE_PIN K1 [get_ports tx_frame_n]
set_property PACKAGE_PIN Y8 [get_ports spi_mosi]
set_property PACKAGE_PIN G1 [get_ports spi_ena]
set_property PACKAGE_PIN AH7 [get_ports spi_sdout]
set_property PACKAGE_PIN W14 [get_ports gpio5_0]
set_property PACKAGE_PIN W13 [get_ports gpio5_1]
set_property PACKAGE_PIN G3 [get_ports spi_clk]
set_property PACKAGE_PIN AF7 [get_ports aclk_p]
set_property PACKAGE_PIN AF6 [get_ports aclk_n]
set_property PACKAGE_PIN V8 [get_ports {ctrl_out_ad[0]}]
set_property PACKAGE_PIN U8 [get_ports {ctrl_out_ad[1]}]
set_property PACKAGE_PIN E4 [get_ports {ctrl_out_ad[2]}]
set_property PACKAGE_PIN E3 [get_ports {ctrl_out_ad[3]}]
set_property PACKAGE_PIN AE9 [get_ports ads_rst]
set_property PACKAGE_PIN Y12 [get_ports ads_pwdn]
set_property PACKAGE_PIN AC7 [get_ports ads_sync]
set_property PACKAGE_PIN F2 [get_ports en_agc_ad]
set_property PACKAGE_PIN K3 [get_ports m5717_ldac]
set_property PACKAGE_PIN T7 [get_ports reset_ad]
set_property PACKAGE_PIN F1 [get_ports rx_ena_ad]
set_property PACKAGE_PIN W8 [get_ports txnrx_ad]
set_property PACKAGE_PIN J1 [get_ports {tx_data[0]}]
set_property PACKAGE_PIN H1 [get_ports {tx_data[1]}]
set_property PACKAGE_PIN H4 [get_ports {tx_data[2]}]
set_property PACKAGE_PIN H3 [get_ports {tx_data[3]}]
set_property PACKAGE_PIN N9 [get_ports {tx_data[4]}]
set_property PACKAGE_PIN N8 [get_ports {tx_data[5]}]
...
set_property PACKAGE_PIN M6 [get_ports {tx_data[10]}]
set_property PACKAGE_PIN L5 [get_ports {tx_data[11]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports tx_frame_n]
...
#set_property IOSTANDARD LVCMOS18 [get_ports aclk_p]
#set_property IOSTANDARD LVCMOS18 [get_ports aclk_n]
set_property IOSTANDARD LVCMOS18 [get_ports {ctrl_out_ad[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {ctrl_out_ad[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {ctrl_out_ad[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {ctrl_out_ad[3]}]
...
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]  ###clk changes
